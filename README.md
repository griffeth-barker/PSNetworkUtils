...
## Getting Started  
### Get the Module
[![PSGallery Version](https://img.shields.io/powershellgallery/v/PSNetworkUtils.png?style=for-the-badge&label=PowerShell%20Gallery)](https://www.powershellgallery.com/packages/PSNetworkUtils/0.1.2/) [![PSGallery Downloads](https://img.shields.io/powershellgallery/dt/PSNetworkUtils.png?style=for-the-badge&label=Downloads)](https://www.powershellgallery.com/packages/PSNetworkUtils/0.1.2/)  
...
### Explore Functions
Once you've imported the module, get started by using `Get-Command -Module PSNetworkUtils` to discover the functions, or by reading the [docs](/docs).
